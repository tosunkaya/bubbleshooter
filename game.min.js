...
var SimpleGame = /** @class */ (function () {
	function SimpleGame() {
		...
		this.boot.preload = function () {
			...
			// this.game.load.image( 'logo', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/splash.png" );
			this.game.load.image('logo', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/1_loading/loading_bg.png");
			this.game.stage.backgroundColor = 0xffffff;
	...
	SimpleGame.prototype.preload = function () {
		...
		var i = 5;
		while (i-- > 1) {
			this.game.load.image('ani_blue_' + i, "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/animation/ani_blue_" + i + ".png");
			this.game.load.image('ani_green_' + i, "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/animation/ani_green_" + i + ".png");
			this.game.load.image('ani_lightblue_' + i, "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/animation/ani_lightblue_" + i + ".png");
			this.game.load.image('ani_purple_' + i, "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/animation/ani_purple_" + i + ".png");
			this.game.load.image('ani_red_' + i, "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/animation/ani_red_" + i + ".png");
			this.game.load.image('ani_yellow_' + i, "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/animation/ani_yellow_" + i + ".png");
		}
		this.game.load.image('bubble_blue', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/bubble_blue.png");
		this.game.load.image('bubble_green', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/bubble_green.png");
		this.game.load.image('bubble_lightblue', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/bubble_lightblue.png");
		this.game.load.image('bubble_purple', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/bubble_purple.png");
		this.game.load.image('bubble_red', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/bubble_red.png");
		this.game.load.image('bubble_yellow', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/bubbles/bubble_yellow.png");
		this.game.load.image('btn_help', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/menu/btn_help.png");
		this.game.load.image('btn_moregames', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/menu/btn_moregames.png");
		this.game.load.image('btn_restart', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/menu/btn_restart.png");
		this.game.load.image('btn_sound', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/menu/btn_sound.png");
		this.game.load.image('btn_top10', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/menu/btn_top10.png");
		this.game.load.image('novice', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/menu/novice.png");
		i = 10;
		while (i-- > 0) {
			this.game.load.image('score_digit_' + i, "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/menu/score_digit_" + i + ".png");
		}
		this.game.load.image('prompt_button_cancel', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/prompts/prompt_button_cancel.png");
		this.game.load.image('prompt_button_ok', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/prompts/prompt_button_ok.png");
		this.game.load.image('prompt_enter-name', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/prompts/prompt_enter-name.png");
		this.game.load.image('prompt_game_over', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/prompts/prompt_game_over.png");
		this.game.load.image('prompt_help', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/prompts/prompt_help.png");
		this.game.load.image('prompt_top10', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/prompts/prompt_top10.png");
		this.game.load.image('canon', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/canon.png");
		this.game.load.image('levels_ball_empty', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/levels_ball_empty.png");
		this.game.load.image('game_bg', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/2_game/game_bg.png");
		this.game.load.image('loading_bg', "https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/1_loading/loading_bg.png");
		this.game.load.audio('1__sstart', ['https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/1__sstart.mp3', 'https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/1__sstart.ogg']);
		this.game.load.audio('2__sconnect', ['https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/2__sconnect.mp3', 'https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/2__sconnect.ogg']);
		this.game.load.audio('3__sbang', ['https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/3__sbang.mp3', 'https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/3__sbang.ogg']);
		this.game.load.audio('3__sbang_3', ['https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/3__sbang_3.mp3', 'https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/3__sbang_3.ogg']);
		this.game.load.audio('3__sbang_4', ['https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/3__sbang_4.mp3', 'https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/3__sbang_4.ogg']);
		this.game.load.audio('3__sbang_5', ['https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/3__sbang_5.mp3', 'https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/3__sbang_5.ogg']);
		this.game.load.audio('4__sdown', ['https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/4__sdown.mp3', 'https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/4__sdown.ogg']);
		this.game.load.audio('5__sgo', ['https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/5__sgo.mp3', 'https://cdn.bubbleshooter.com/games/bubbleshooter-game/assets/sound/5__sgo.ogg']);
	};
